...
const Earth: React.FC = () => {
  const { scene, animations } = useGLTF("./muscular_bodybuilder_boxing_fighter/scene.gltf") as GLTFResult;
...
useGLTF.preload("./muscular_bodybuilder_boxing_fighter/scene.gltf");
