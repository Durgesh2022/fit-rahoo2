  ...
  />
    ...
    <div className="flex items-center justify-center min-h-screen  px-4 gap-8">
      ...
      <div className="text-white w-[750px]">
        <h2 className="text-7xl font-bold leading-tight border-t border-b border-white font-normal " style={{ fontFamily: "'CAMPUS PERSONAL USE', sans-serif"}}>
...
{"To get started, all you need to do is follow three simple steps. These steps are backed by science, crafted by experts, and easy to integrate into your daily routine. Ready to unlock the healthiest, most exciting version of yourself?"}
      ...
      <div className="rounded-full border-2 border-white p-2 w-[700px] h-[700px] overflow-hidden relative">
        <ComparisonSlider />
      </div>
  ...
  <div className="flex flex-col items-center px-6 py-8 cut-corners border-t border-white">
    <h2 className="text-5xl  mb-8 font-normal text-[#fe6107]" style={{ fontFamily: "'CAMPUS PERSONAL USE', sans-serif"}}>Step 1</h2>
    <img
...
/>
    ...
    <h3 className="text-2xl font-bold mb-6 font-normal" style={{ fontFamily: "'CAMPUS PERSONAL USE', sans-serif"}}>Check Your BMI & BMR</h3>
  ...
  <div className="flex flex-col items-center px-6 py-8 cut-corners border-t border-l border-white">
    <h2 className="text-5xl  mb-8 font-normal text-[#fe6107]" style={{ fontFamily: "'CAMPUS PERSONAL USE', sans-serif"}}>Step 2</h2>
    <img
...
/>
    ...
    <h3 className="text-2xl font-bold mb-2 font-normal" style={{ fontFamily: "'CAMPUS PERSONAL USE', sans-serif"}}>Get Your Workout Plan</h3>
    <p className="text-gray-300 text-center mb-4">
  ...
  {/* Step 3 */}
  <div className="flex flex-col items-center px-6 py-8 cut-corners border-t border-l border-white">
    <h2 className="text-5xl  mb-8 font-normal text-[#fe6107]" style={{ fontFamily: "'CAMPUS PERSONAL USE', sans-serif"}}>Step 3</h2>
    <img
  src="https://i.pinimg.com/736x/92/e6/25/92e62501bd4a6db3cf3c7aaf04025b36.jpg"
  alt="Step 1"
  className="mb-4 w-full h-[260px] max-h-[20vh] object-cover filter grayscale rounded-lg"
/>

    <h3 className="text-2xl font-bold mb-2 font-normal" style={{ fontFamily: "'CAMPUS PERSONAL USE', sans-serif"}}>Check Your Exercise Form </h3>
    <p className="text-gray-300 text-center mb-4">
...
<div className="flex justify-center mt-8 mb-16">
  <button className="px-6 py-3 bg-[#fe6107] text-black text-lg rounded-lg hover:bg-orange-600 transition" style={{ fontFamily: "'CAMPUS PERSONAL USE', sans-serif"}}>
    {"Let's Get Started"}
  </button>
</div>
